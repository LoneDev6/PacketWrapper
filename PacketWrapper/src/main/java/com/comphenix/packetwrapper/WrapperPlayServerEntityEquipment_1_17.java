...
public class WrapperPlayServerEntityEquipment_1_17 extends WrapperPlayServerEntityEquipment
{
	...
	{
		final List<Pair<EnumItemSlot, net.minecraft.world.item.ItemStack>>old =
				(List<Pair<EnumItemSlot, net.minecraft.world.item.ItemStack>>) handle.getModifier().withType(List.class).read(0);
